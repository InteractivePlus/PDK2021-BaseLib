...
abstract class APPTokenEntityStorage{
    ...
    public abstract function getAPPTokenCount(int $issueTimeMin = 0, int $issueTimeMax = 0, int $expireTimeMin = 0, int $expireTimeMax =0, int $lastRenewTimeMin = 0, int $lastRenewTimeMax = 0, int $refreshExpireMin = 0, int $refreshExpireMax = 0, ?string $maskID = null, int $appid = APPSystemConstants::NO_APP_RELATED_APPUID) : int;

    public abstract function clearAPPToken(int $issueTimeMin = 0, int $issueTimeMax = 0, int $expireTimeMin = 0, int $expireTimeMax =0, int $lastRenewTimeMin = 0, int $lastRenewTimeMax = 0, int $refreshExpireMin = 0, int $refreshExpireMax = 0, ?string $maskID = null, int $appid = APPSystemConstants::NO_APP_RELATED_APPUID) : void;

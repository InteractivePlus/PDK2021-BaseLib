...
use InteractivePlus\PDK2021\Base\Exception\ExceptionTypes\PDKInnerError;
...
abstract class LoggerStorage extends \Psr\Log\AbstractLogger{
     ...
     * @throws \InteractivePlus\PDK2021\Base\Exception\ExceptionTypes\PDKStorageEngineError if there was an error storing the LogEntity
     */
     ...
     * @param int $highestLogLevel @see \InteractivePlus\PDK2021\Base\Logger\PDKLogLevel

...
abstract class VeriCodeEmailSender implements VeriCodeSender{
    public abstract function sendImportantAction(VeriCodeEntity $codeEntity, UserEntity $user, string $destination) : void;

    public abstract function sendChangePassword(VeriCodeEntity $codeEntity, UserEntity $user, string $destination) : void;

    public abstract function sendForgotPassword(VeriCodeEntity $codeEntity, UserEntity $user, string $destination) : void;

    public abstract function sendChangeEmail(VeriCodeEntity $codeEntity, UserEntity $user, string $destination, string $newEmail) : void;

    public abstract function sendChangePhone(VeriCodeEntity $codeEntity, UserEntity $user, string $destination, string $newPhoneNum) : void;

    public abstract function sendAdminAction(VeriCodeEntity $codeEntity, UserEntity $user, string $destination) : void;

    public abstract function sendThirdAPPImportantAction(VeriCodeEntity $codeEntity, UserEntity $user, string $destination) : void;

    public abstract function sendThirdAPPDeleteAction(VeriCodeEntity $codeEntity, UserEntity $user, string $destination) : void;

    public abstract function sendVerifyEmail(VeriCodeEntity $codeEntity, UserEntity $user, string $destination) : void;
    ...
    public function sendVeriCode(VeriCodeEntity $veriCode, UserEntity $user, $destination) : void{
        switch($veriCode->getVeriCodeID()->getVeriCodeID()){
            case VeriCodeID::$VERICODE_VERIFY_EMAIL->getVeriCodeID():
                $this->sendVerifyEmail($veriCode,$user,$destination);
                break;

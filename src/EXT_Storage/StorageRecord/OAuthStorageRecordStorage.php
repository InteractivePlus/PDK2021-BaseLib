...
abstract class OAuthStorageRecordStorage{
    ...
    public abstract function clearStorageRecord(int $createTimeStart = -1, int $createTimeEnd = -1, int $lastUpdateStart = -1, int $lastUpdateEnd = -1, ?string $relatedMaskID = null, ?string $relatedClientID = null, int $relatedAPPUID = APPSystemConstants::NO_APP_RELATED_APPUID, int $dataOffset = 0, int $dataCountLimit = -1) : void;
}